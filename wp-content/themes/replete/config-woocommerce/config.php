...
#
remove_action( 'woocommerce_taxonomy_archive_description', 'woocommerce_taxonomy_archive_description', 10 );
...
function avia_woocommerce_cart_dropdown()
{
	...
	ob_start();
    the_widget('WooCommerce_Widget_Cart_Kriesi', '', array('widget_id'=>'cart-dropdown',
        'before_widget' => '',
        'after_widget' => '',
