...
class avia_socialcount extends WP_Widget {
	...
	function avia_socialcount() {
		//Constructor
		$widget_ops = array('classname' => 'avia_socialcount', 'description' => 'A widget to display your twitter followers and rss link' );
		$this->WP_Widget( 'avia_socialcount', THEMENAME.' RSS Link and Twitter count', $widget_ops );
	}
...
class avia_google_maps extends WP_Widget {
	...
	function form($instance) {
		...
		?>
			...
			<p>
			Enter the latitude and longitude of the location. You can <a target='_blank' href='http://www.getlatlon.com/'>fetch them here</a> or <a href='http://itouchmap.com/latlong.html' target='blank'>here</a><br/><br/>
