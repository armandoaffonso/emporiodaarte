...
function r_banner_728_90($atts, $content = null) {
...
$result = '<div class="banner_728_90"><a href="'.$link.'" title="'.$title.'" alt="'.$title.'">
<img src="'.$image.'" alt="'.$title.'">
</a></div><div class="clear"></div>';
return $result;	
}
add_shortcode('banner_728_90', 'r_banner_728_90');
...
function r_home_four_posts($atts, $content = null) {
	extract(shortcode_atts(array(
	'title' => 'Title',
	'color' => '',
	'category' => '',
	...
	ob_start();
?>	
<div class="home_posts_container_two" style="border-left-color: #<?php echo $color ?>;">
<div class="home_posts_title"><span style="background-color: #<?php echo $color ?>;"><h2>
...
<?php echo '<a href="?cat='. $category_ID .'">'; echo $title; ?></a>
		...
		<?php $i++ ?>
		<div class="home_posts_two<?php if ($i == 1) echo '_first'; ?>">
		...
		<?php if ($i == 1) { ?>
		<?php $image = aq_resize( $thumbnailSrc, 270, 280, true ); ?>
        <img src="<?php echo $image ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>"/>
        <?php } else { ?>
		<?php $image = aq_resize( $thumbnailSrc, 100, 80, true ); ?>
        <img src="<?php echo $image ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>"/>
		<?php } ?>
		</a>
		...
		<h1><a style="background-color: #<?php echo $color ?>;" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" ><?php the_title(); ?> &raquo;</a></h1>
...
add_shortcode("home_four_posts", "r_home_four_posts");





function r_home_four_posts_simple($atts, $content = null) {
	extract(shortcode_atts(array(
	'title' => 'Title',
	'color' => '',
	'category' => '',
...
<?php echo '<a href="?cat='. $category_ID .'">'; echo $title; ?></a>
		...
		<?php while ( have_posts() ) : $wp_query->the_post(); ?>
		<?php $i++ ?>
		<div class="home_posts_two_simple<?php if ($i == 1) echo '_first'; ?>">
        ...
        <a href="<?php the_permalink() ?>" title="<?php the_title(); ?>">
		<?php if ($i == 1) { ?>
		<?php $image = aq_resize( $thumbnailSrc, 270, 220, true ); ?>
        <img src="<?php echo $image ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>"/>
        <?php } else { ?>
		<?php $image = aq_resize( $thumbnailSrc, 100, 80, true ); ?>
        <img src="<?php echo $image ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>"/>
...
add_shortcode("home_four_posts_simple", "r_home_four_posts_simple");




function r_home_posts_two_column($atts, $content = null) {
	extract(shortcode_atts(array(
	'title' => 'Title',
	'color' => '',
	'category' => '',
	...
	ob_start();
?>	
<div class="home_posts_container_two_column" style="border-left-color: #<?php echo $color ?>;">
<div class="home_posts_title"><span style="background-color: #<?php echo $color ?>;"><h2>
<?php $category_ID = get_category_id($category); ?>
<?php echo '<a href="?cat='. $category_ID .'">'; echo $title; ?></a>
</h2></span></div>
        ...
        <a href="<?php the_permalink() ?>" title="<?php the_title(); ?>">
		<?php if ($i == 1) { ?>
		<?php $image = aq_resize( $thumbnailSrc, 280, 220, true ); ?>
        <img src="<?php echo $image ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>"/>
        <?php } else {} ?>
		</a>
...
add_shortcode("home_posts_two_column", "r_home_posts_two_column");
...
function r_home_posts_two_column_simple($atts, $content = null) {
	extract(shortcode_atts(array(
	'title' => 'Title',
	'color' => '',
	'category' => '',
...
<?php echo '<a href="?cat='. $category_ID .'">'; echo $title; ?></a>
        ...
        <a href="<?php the_permalink() ?>" title="<?php the_title(); ?>">
		<?php if ($i == 1) { ?>
		<?php $image = aq_resize( $thumbnailSrc, 280, 180, true ); ?>
        <img src="<?php echo $image ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>"/>
        <?php } else {} ?>
		</a>
...
add_shortcode("home_posts_two_column_simple", "r_home_posts_two_column_simple");





function r_home_posts_one_column($atts, $content = null) {
	extract(shortcode_atts(array(
	'title' => 'Title',
	'color' => '',
	'category' => '',
	...
	ob_start();
?>	
<div class="home_posts_container" style="border-left-color: #<?php echo $color ?>;">
<div class="home_posts_title"><span style="background-color: #<?php echo $color ?>;"><h2>
<?php $category_ID = get_category_id($category); ?>
<?php echo '<a href="?cat='. $category_ID .'">'; echo $title; ?></a>
</h2></span></div>
        ...
        <a href="<?php the_permalink() ?>" title="<?php the_title(); ?>">
		<?php $image = aq_resize( $thumbnailSrc, 160, 100, true ); ?>
        <img src="<?php echo $image ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>"/>
        </a>
...
add_shortcode("home_posts_one_column", "r_home_posts_one_column");
...
function r_home_posts_one_column_simple($atts, $content = null) {
	extract(shortcode_atts(array(
	'title' => 'Title',
	'color' => '',
	'category' => '',
...
<?php echo '<a href="?cat='. $category_ID .'">'; echo $title; ?></a>
		...
		<div class="home_posts_one_simple">
...
add_shortcode("home_posts_one_column_simple", "r_home_posts_one_column_simple");




function r_home_carousel_posts($atts, $content = null) {
	extract(shortcode_atts(array(
	'title' => 'Title',
	'color' => '',
	'category' => '',
	...
	ob_start();
?>	
<div class="jcarousel_container" style="border-left-color: #<?php echo $color ?>;">
<div class="home_posts_title"><span style="background-color: #<?php echo $color ?>;"><h2>
<?php $category_ID = get_category_id($category); ?>
<?php echo '<a href="?cat='. $category_ID .'">'; echo $title; ?></a>
</h2></span></div>
<ul class="jcarousel-skin-tango">
        ...
        <a href="<?php the_permalink() ?>" title="<?php the_title(); ?>">
		<?php $image = aq_resize( $thumbnailSrc, 195, 190, true ); ?>
        <img src="<?php echo $image ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>"/>
        </a>
...
add_shortcode("home_carousel_posts", "r_home_carousel_posts");
...
<?php echo '<a href="?cat='. $category_ID .'">'; echo $title; ?></a>
    ...
    <div class="pikachoose">
		...
		<li>
        <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
		<?php $image = aq_resize( $thumbnailSrc, 405, 224, true ); ?>
        <img class="tip" src="<?php echo $image ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>"/>
        </a>
...
function r_home_posts_pictures($atts, $content = null) {
	extract(shortcode_atts(array(
	'title' => 'Title',
	'color' => '',
	'category' => '',
...
<?php echo '<a href="?cat='. $category_ID .'">'; echo $title; ?></a>
		...
		<?php $image = aq_resize( $thumbnailSrc, 140, 140, true ); ?>
        <img class="tip" src="<?php echo $image ?>" alt="<?php the_title(); ?>" title="<?php the_title(); ?>"/>
        </a>
...
add_shortcode("home_posts_pictures", "r_home_posts_pictures");
...
<div class="home_posts_title"><span style="background-color: #<?php echo $color ?>;"><h2>'.$title.'</h2></span></div><div class="home_custom_post_box">'.do_shortcode($content).'</div></div><div class="clear"></div>';	
}
