<?php
	class add_rshortcode_button {
	var $pluginname = 'rpanel';
	var $path = '';
	var $internalVersion = 100;
	
	function add_rshortcode_button()  
	{
	...
	function add_tinymce_langs_path($plugin_array) 
	{
		...
		$plugin_array[$this->pluginname] = get_template_directory_uri() . '/includes/tinymce/langs.php';
		return $plugin_array;
	}
...
// Call it now
$tinymce_button = new add_rshortcode_button ();
