...
class royal_video_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		$defaults = array(
		'title' => 'My Video',
		'embed' => stripslashes( '<object style="height: 150px; width: 260px">
        <param name="movie" value="http://www.youtube.com/v/LZfHjn6KDCc?version=3&feature=player_detailpage"><param name="allowFullScreen" value="true"><param name="allowScriptAccess" value="always"><embed src="http://www.youtube.com/v/LZfHjn6KDCc?version=3&feature=player_detailpage" type="application/x-shockwave-flash" allowfullscreen="true" allowScriptAccess="always" width="260" height="150">
        </object>'),
