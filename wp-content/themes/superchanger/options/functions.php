...
function admin_js(){
	...
	wp_enqueue_script('options_ui',$options_jsfolder . '/jquery-ui.min.js');
...
function css_admin() { ?> 
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/options/css/panel.css" type="text/css" />
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/options/css/jquery.sb.css" type="text/css" />
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/options/css/jquery-ui.css" type="text/css" />
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/options/css/tipTip.css" type="text/css" />
<?php }
...
if (($value['type'] == "text") || ($value['type'] == "textarea") || ($value['type'] == "select") || ($value['type'] == "checkboxes") || ($value['type'] == "colorpicker") || ($value['type'] == "textcolorpopup") || ($value['type'] == "upload")) { ?>
			<div class="options-box">
			  ...
			  <div class="box-title">
				<h3><?php echo $value['name']; ?></h3>
				    <img src="<?php echo get_template_directory_uri() ?>/options/images/quest.png" class="tip" title="<?php echo $value['desc']; ?>"/>
		      </div> 
        ...
        <?php } elseif ($value['type'] == "upload") { ?>
			...
			<input id="<?php echo $value['id']; ?>" class="uploadfield" type="text" style="width: 250px;" name="<?php echo $value['id']; ?>" value="<?php echo(get_option($value['id'])); ?>" />
...
<?php } elseif (($value['type'] == "checkbox")) { ?><div class="options-box <?php if ($value['type'] == "checkbox") {echo('options-tabs');} ?>">
			  <div class="box-title"><h3><?php echo $value['name']; ?></h3><img src="<?php echo get_template_directory_uri() ?>/options/images/quest.png" class="tip" title="<?php echo $value['desc']; ?>"/></div> 
				<div class="box-content">
	<?php $checked = '';
