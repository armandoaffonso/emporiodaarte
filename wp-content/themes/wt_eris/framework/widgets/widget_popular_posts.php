 ...
 * Description: This widhet displays the most popular posts with thumbnails in the sidebar.
 * Version: 1.0
...
class wellthemes_popular_posts_widget extends WP_Widget {
	...
	function wellthemes_popular_posts_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_posts', 'description' => __('Displays the most popular posts with thumbnails in the sidebar.', 'wellthemes') );
	...
	function widget( $args, $instance ) {
	   ...
	   if(empty($entries_display)){ $entries_display = '5'; }
        ...
        $latest_posts->query('ignore_sticky_posts=1&showposts='.$entries_display.'&orderby=comment_count&cat='.$display_category.'');
