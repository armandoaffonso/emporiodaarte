...
<div id="container" class="hfeed">
	...
	<header id="header" role="banner">
		<?php
			//include top header
			if ( wt_get_option( 'wt_header_top' ) == 1 ) {			
		?>	
		
		<div class="top clearfix">
			
			<div id="top-menu">
				<?php wp_nav_menu( array( 'theme_location' => 'secondary-menu', 'container' => '0', 'fallback_cb' => 'wellthemes_top_menu_fallback',) ); ?>
			</div>
			...
			<div class="top-right">
				<ul>
					...
					<?php if (wt_get_option( 'wt_contact_url' )) { ?>
						<li><a class="email" href="<?php echo wt_get_option( 'wt_contact_url' ); ?>">Contact</a></li>
					<?php } ?>					
	...
	?>	
		...
		<div class="wrap">
			...
			<?php if (wt_get_option( 'wt_header_ad468' )) {?>
				<div class="ad468">	
					<?php echo wt_get_option( 'wt_header_ad468' ); ?>	
				</div>
			<?php } ?>
