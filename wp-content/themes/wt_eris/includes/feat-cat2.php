...
?>
<?php
	$feat_cat2_id = wt_get_option('wt_feat_cat2');											//get category id														
	$post_query1 = 'cat='.$feat_cat2_id.'&posts_per_page=1&ignore_sticky_posts=1';				//get  main post
	$post_query2 = 'cat='.$feat_cat2_id.'&posts_per_page=4&offset=1&ignore_sticky_posts=1';	//get 4 more posts
	$feat_cat2_name = get_cat_name($feat_cat2_id);											//get category name
	$feat_cat2_url = get_category_link($feat_cat2_id );										//get category url.	
?>

<section class="feat-cat">
	<header class="cat-header">
		<h3><a href="<?php echo esc_url( $feat_cat2_url ); ?>" ><?php echo $feat_cat2_name; ?></a></h3>
	</header>
