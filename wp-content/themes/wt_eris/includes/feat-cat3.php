...
?>
<?php
	$feat_cat3_id = wt_get_option('wt_feat_cat3');											//get category id														
	$post_query1 = 'cat='.$feat_cat3_id.'&posts_per_page=1&ignore_sticky_posts=1';				//get  main post
	$post_query2 = 'cat='.$feat_cat3_id.'&posts_per_page=4&offset=1&ignore_sticky_posts=1';	//get 4 more posts
	$feat_cat3_name = get_cat_name($feat_cat3_id);											//get category name
	$feat_cat3_url = get_category_link($feat_cat3_id );										//get category url.	
?>

<section class="feat-cat">
	<header class="cat-header">
		<h3><a href="<?php echo esc_url( $feat_cat3_url ); ?>" ><?php echo $feat_cat3_name; ?></a></h3>
	</header>
